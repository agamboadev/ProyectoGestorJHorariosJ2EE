...
/**
 * Servlet Filter implementation class FiltroZonaProfesor
 */
public class FiltroZonaProfesor implements Filter {

    /**
     * Default constructor. 
     */
    public FiltroZonaProfesor() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		System.out.println("Entra en el filtro FiltroZonaProfesor");
